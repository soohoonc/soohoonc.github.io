    ...
    <main>
      <div className="flex w-screen h-screen justify-center items-center">
        <Card className="max-w-lg text-sm border-none text-justify leading-relaxed">
          ...
          I am currently based in <a className="text-red-500" href="https://www.google.com/maps/place/San+Francisco">San Francisco</a> and am always down to grab a coffee. 
          I recently graduated <a className="text-yellow-400" href="https://www.gatech.edu/">Georgia Tech</a> with a degree in Computer Science and Mathematics.
