...
const Page = () => {
  return (
    <div className='w-full h-screen p-0 m-0'>
      ...
      <p className='my-2'>
        Cofounder at{' '}
        <a href='https://greptile.com' target='_blank'>
          Greptile
        </a>
        .<br />
      ...
      <div className='flex flex-row space-x-2'>
        <div>
          <a href='https://github.com/soohoonc'>Github</a>
        </div>
        <div>
          <a href='https://linkedin.com/in/soohoonchoi'>LinkedIn</a>
        </div>
        <div>
          <a href='https://x.com/soohoonchoi'>Twitter</a>
        </div>
      </div>
      <Shell />
    </div>
