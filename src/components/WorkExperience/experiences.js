...
[
  ...
  },
  {
    ...
    location: 'Atlanta, GA',
    description: <>Incoming teaching assistant for the computer vision/deep learnings class for graduate and undergraduate students.</>,
  ...
  //   description: <></>,
  //   skills: [],
  //   media: '/assets/images/experiences/',
  // },
]